...
if(!function_exists('optionsframework_options')) {
	function optionsframework_options() {
		...
		$options['bnr_top'] = array( "name" => "Header Banner",
							"desc" => "Click Upload or Enter the direct path to your <strong>Header Banner</strong>. For example <em>http://your_website_url_here/wp-content/uploads/2013/01/bnr-top.png</em>",
							"id" => "bnr_top",
