...
(function ($) {
    ...
    Filestyle.prototype = {
        ...
        htmlInput: function () {
            if (this.options.input) {
                return '<input type="text" class="'+this.options.classInput+'" disabled placeholder="Attach Files">';
            } else {
                return '';
            }
        },
        ...
        constructor: function () {
            ...
            this.$elementFilestyle = $('<div class="bootstrap-filestyle" style="display: inline;">'+html+'<div class="clear"></div></div>');
