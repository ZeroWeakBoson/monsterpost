	...
	foreach ( $options as $value ) {
		...
		case 'typography':
			...
			$typography_options = array(
				...
				'characters' => of_recognized_font_characters(),
				'styles' => of_recognized_font_styles(),
				'lineheight' => of_recognized_font_sizes(),
				'color' => true
			);
			...
			if ( $typography_options['sizes'] ) {
				$font_size = '<div class="field"><label for="of-typography-size">Font Size</label>';
			...
			if ( $typography_options['lineheight'] ) {
				$font_lineheight = '<div class="field"><label for="of-typography-lineheight">Lineheight</label>';
			...
			if ( $typography_options['faces'] ) {
				$font_face = '<div class="field"><label for="of-typography-face">Font Face</label>';
			...
			if ( $typography_options['characters'] ) {
				$font_character = '<div class="field"><label for="of-typography-character">Character Sets</label>';
			...
			if ( $typography_options['styles'] ) {
				$font_style = '<div class="field"><label for="of-typography-style">Font Style</label>';
			...
			if ( $typography_options['color'] ) {
				$font_color = '<div class="field"><label for="of-typography-color">Color</label>';
