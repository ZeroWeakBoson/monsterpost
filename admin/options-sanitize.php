...
if ( !function_exists( 'options_typography_google_fonts' ) ) {
	function options_typography_google_fonts() {
		...
		$selected_character['h5_heading'] = $h6_heading['character'];
	 ...
	 // }
		...
		if ( of_get_option( 'menu_typography' ) ) {
		  $input = of_get_option( 'menu_typography' );
					$output .= options_typography_font_styles( of_get_option( 'menu_typography' ) , '.sf-menu');
	 }
