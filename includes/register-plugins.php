...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => PARENT_DIR . '/includes/plugins/contact-form-7.zip', // The plugin source
		...
		array(
			...
			'source'             => PARENT_DIR . '/includes/plugins/oauth-twitter-feed-for-developers.zip', // The plugin source
			'required'           => true, // If false, the plugin is only 'recommended' instead of required
			'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			'name'               => 'Efficient Related Posts (Custom)', // The plugin name
			'slug'               => 'efficient-related-posts-custom', // The plugin slug (typically the folder name)
			'source'             => PARENT_DIR . '/includes/plugins/efficient-related-posts-custom.zip', // The plugin source
			'required'           => true, // If false, the plugin is only 'recommended' instead of required
			'version'            => '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
	...
	$config = array(
		...
		'strings'          => array(
			...
			'complete'                        => __( 'All plugins installed and activated successfully. %s', 'cherry' ), // %1$s = dashboard link
