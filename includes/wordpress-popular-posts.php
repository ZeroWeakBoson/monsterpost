...
if ( !class_exists('WordpressPopularPosts') ) {
	...
	class WordpressPopularPosts extends WP_Widget {
		...
		function WordpressPopularPosts() {
			...
			// widget settings
			$widget_ops = array( 'classname' => 'popular-posts', 'description' => __('The most Popular Posts on your blog.', 'cherry') );
			...
			// set theme path
			if (empty($this->themeDir)) $this->themeDir = PARENT_URL;
			
			// set default thumbnail
			$this->default_thumbnail = $this->themeDir . "/images/no_thumb.jpg";
		...
		function form($instance) {
			...
			// form
			?>
			<p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'cherry'); ?></label>  <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small> <br />
			...
			<p><label for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e('Show up to:', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />
			<input type="text" id="<?php echo $this->get_field_id( 'limit' ); ?>" name="<?php echo $this->get_field_name( 'limit' ); ?>" value="<?php echo $instance['limit']; ?>"  class="widefat" style="width:50px!important" /> <?php _e('posts', 'cherry'); ?></p>
			<p><label for="<?php echo $this->get_field_id( 'range' ); ?>"><?php _e('Time Range:', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />
			<select id="<?php echo $this->get_field_id( 'range' ); ?>" name="<?php echo $this->get_field_name( 'range' ); ?>" class="widefat">
				<option value="daily" <?php if ( 'daily' == $instance['range'] ) echo 'selected="selected"'; ?>><?php _e('Last 24 hours', 'cherry'); ?></option>
				<option value="weekly" <?php if ( 'weekly' == $instance['range'] ) echo 'selected="selected"'; ?>><?php _e('Last 7 days', 'cherry'); ?></option>
				<option value="monthly" <?php if ( 'monthly' == $instance['range'] ) echo 'selected="selected"'; ?>><?php _e('Last 30 days', 'cherry'); ?></option>
				<option value="all" <?php if ( 'all' == $instance['range'] ) echo 'selected="selected"'; ?>><?php _e('All-time', 'cherry'); ?></option>
			</select>
			</p>
			<p><label for="<?php echo $this->get_field_id( 'order_by' ); ?>"><?php _e('Sort posts by:', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small> <br />
			<select id="<?php echo $this->get_field_id( 'order_by' ); ?>" name="<?php echo $this->get_field_name( 'order_by' ); ?>" class="widefat">
				<option value="comments" <?php if ( 'comments' == $instance['order_by'] ) echo 'selected="selected"'; ?>><?php _e('Comments', 'cherry'); ?></option>
				<option value="views" <?php if ( 'views' == $instance['order_by'] ) echo 'selected="selected"'; ?>><?php _e('Total views', 'cherry'); ?></option>
				<option value="avg" <?php if ( 'avg' == $instance['order_by'] ) echo 'selected="selected"'; ?>><?php _e('Avg. daily views', 'cherry'); ?></option>
			</select>
			</p>
			
			<fieldset style="width:214px; padding:5px; border: 1px solid #ddd"  class="widefat">
				<legend><?php _e('Posts settings', 'cherry'); ?></legend>
				<?php if ($this->postRating) : ?>
				<input type="checkbox" class="checkbox" <?php echo ($instance['rating']) ? 'checked="checked"' : ''; ?> id="<?php echo $this->get_field_id( 'rating' ); ?>" name="<?php echo $this->get_field_name( 'rating' ); ?>" /> <label for="<?php echo $this->get_field_id( 'rating' ); ?>"><?php _e('Display post rating', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />
				<?php endif; ?>
				<input type="checkbox" class="checkbox" <?php echo ($instance['shorten_title']['active']) ? 'checked="checked"' : ''; ?> id="<?php echo $this->get_field_id( 'shorten_title-active' ); ?>" name="<?php echo $this->get_field_name( 'shorten_title-active' ); ?>" /> <label for="<?php echo $this->get_field_id( 'shorten_title-active' ); ?>"><?php _e('Shorten title', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />
				<?php if ($instance['shorten_title']['active']) : ?>
				<label for="<?php echo $this->get_field_id( 'shorten_title-length' ); ?>"><?php _e('Shorten title to', 'cherry'); ?> <input id="<?php echo $this->get_field_id( 'shorten_title-length' ); ?>" name="<?php echo $this->get_field_name( 'shorten_title-length' ); ?>" value="<?php echo $instance['shorten_title']['length']; ?>" class="widefat" style="width:50px!important" /> <?php _e('characters', 'cherry'); ?></label><br /><br />
				<?php endif; ?>
				<input type="checkbox" class="checkbox" <?php echo ($instance['post-excerpt']['active']) ? 'checked="checked"' : ''; ?> id="<?php echo $this->get_field_id( 'post-excerpt-active' ); ?>" name="<?php echo $this->get_field_name( 'post-excerpt-active' ); ?>" /> <label for="<?php echo $this->get_field_id( 'post-excerpt-active' ); ?>"><?php _e('Display post excerpt', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />
				<?php if ($instance['post-excerpt']['active']) : ?>
				<fieldset class="widefat" style="border: 1px solid #ddd">
					<legend><?php _e('Excerpt Properties', 'cherry'); ?></legend>
					&nbsp;&nbsp;<input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'post-excerpt-format' ); ?>" name="<?php echo $this->get_field_name( 'post-excerpt-format' ); ?>" <?php echo ($instance['post-excerpt']['keep_format']) ? 'checked="checked"' : ''; ?> /> <label for="<?php echo $this->get_field_id( 'post-excerpt-format' ); ?>"><?php _e('Keep text format and links', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />
					&nbsp;&nbsp;<label for="<?php echo $this->get_field_id( 'post-excerpt-length' ); ?>"><?php _e('Excerpt length:', 'cherry'); ?> <input id="<?php echo $this->get_field_id( 'post-excerpt-length' ); ?>" name="<?php echo $this->get_field_name( 'post-excerpt-length' ); ?>" value="<?php echo $instance['post-excerpt']['length']; ?>" class="widefat" style="width:30px!important" /> <?php _e('characters', 'cherry'); ?></label>
				</fieldset>
				<br />
				<?php endif; ?>
			</fieldset>
			...
			<fieldset class="widefat" style="border: 1px solid #ddd">
				<legend><?php _e('Filters:', 'cherry'); ?> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small></legend><br />
				&nbsp;&nbsp;<label for="<?php echo $this->get_field_id( 'post_type' ); ?>"><?php _e('Post type(s):', 'cherry'); ?></label><br />
				&nbsp;&nbsp;<input type="text" id="<?php echo $this->get_field_id( 'post_type' ); ?>" name="<?php echo $this->get_field_name( 'post_type' ); ?>" value="<?php echo $instance['post_type']; ?>" class="widefat" style="width:150px" /><br /><br />
				&nbsp;&nbsp;<label for="<?php echo $this->get_field_id( 'cat' ); ?>"><?php _e('Category(ies) ID(s):', 'cherry'); ?></label><br />
				&nbsp;&nbsp;<input type="text" id="<?php echo $this->get_field_id( 'cat' ); ?>" name="<?php echo $this->get_field_name( 'cat' ); ?>" value="<?php echo $instance['cat']; ?>" class="widefat" style="width:150px" /><br /><br />
				&nbsp;&nbsp;<label for="<?php echo $this->get_field_id( 'uid' ); ?>"><?php _e('Author(s) ID(s):', 'cherry'); ?></label><br />
				&nbsp;&nbsp;<input type="text" id="<?php echo $this->get_field_id( 'uid' ); ?>" name="<?php echo $this->get_field_name( 'uid' ); ?>" value="<?php echo $instance['author']; ?>" class="widefat" style="width:150px" /><br /><br />
			</fieldset>
			<br />
			
			<fieldset style="width:214px; padding:5px; border: 1px solid #ddd"  class="widefat">
				<legend><?php _e('Thumbnail settings', 'cherry'); ?></legend>
				<input type="checkbox" class="checkbox" <?php echo ($instance['thumbnail']['active']) ? 'checked="checked"' : ''; ?> id="<?php echo $this->get_field_id( 'thumbnail-active' ); ?>" name="<?php echo $this->get_field_name( 'thumbnail-active' ); ?>" /> <label for="<?php echo $this->get_field_id( 'thumbnail-active' ); ?>"><?php _e('Display post thumbnail', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />
				<?php if($instance['thumbnail']['active']) : ?>
				<label for="<?php echo $this->get_field_id( 'thumbnail-width' ); ?>"><?php _e('Width:', 'cherry'); ?></label> 
				<input id="<?php echo $this->get_field_id( 'thumbnail-width' ); ?>" name="<?php echo $this->get_field_name( 'thumbnail-width' ); ?>" value="<?php echo $instance['thumbnail']['width']; ?>"  class="widefat" style="width:30px!important" <?php echo ($this->thumb) ? '' : 'disabled="disabled"' ?> /> <?php _e('px', 'cherry'); ?> <br />
				<label for="<?php echo $this->get_field_id( 'thumbnail-height' ); ?>"><?php _e('Height:', 'cherry'); ?></label> 
				<input id="<?php echo $this->get_field_id( 'thumbnail-height' ); ?>" name="<?php echo $this->get_field_name( 'thumbnail-height' ); ?>" value="<?php echo $instance['thumbnail']['height']; ?>"  class="widefat" style="width:30px!important" <?php echo ($this->thumb) ? '' : 'disabled="disabled"' ?> /> <?php _e('px', 'cherry'); ?><br />
				<?php endif; ?>
			</fieldset>
			
			<br />
			<fieldset style="width:214px; padding:5px; border: 1px solid #ddd"  class="widefat">
				<legend><?php _e('Stats Tag settings', 'cherry'); ?></legend>
				<input type="checkbox" class="checkbox" <?php echo ($instance['stats_tag']['comment_count']) ? 'checked="checked"' : ''; ?> id="<?php echo $this->get_field_id( 'comment_count' ); ?>" name="<?php echo $this->get_field_name( 'comment_count' ); ?>" /> <label for="<?php echo $this->get_field_id( 'comment_count' ); ?>"><?php _e('Display comment count', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />                
				<input type="checkbox" class="checkbox" <?php echo ($instance['stats_tag']['views']) ? 'checked="checked"' : ''; ?> id="<?php echo $this->get_field_id( 'views' ); ?>" name="<?php echo $this->get_field_name( 'views' ); ?>" /> <label for="<?php echo $this->get_field_id( 'views' ); ?>"><?php _e('Display views', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />            
				<input type="checkbox" class="checkbox" <?php echo ($instance['stats_tag']['author']) ? 'checked="checked"' : ''; ?> id="<?php echo $this->get_field_id( 'author' ); ?>" name="<?php echo $this->get_field_name( 'author' ); ?>" /> <label for="<?php echo $this->get_field_id( 'author' ); ?>"><?php _e('Display author', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />            
				<input type="checkbox" class="checkbox" <?php echo ($instance['stats_tag']['date']['active']) ? 'checked="checked"' : ''; ?> id="<?php echo $this->get_field_id( 'date' ); ?>" name="<?php echo $this->get_field_name( 'date' ); ?>" /> <label for="<?php echo $this->get_field_id( 'date' ); ?>"><?php _e('Display date', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small>
				<?php if ($instance['stats_tag']['date']['active']) : ?>                	
					<fieldset class="widefat">
						<legend><?php _e('Date Format', 'cherry'); ?></legend>
			...
			<fieldset style="width:214px; padding:5px; border: 1px solid #ddd"  class="widefat">
				<legend><?php _e('HTML Markup settings', 'cherry'); ?></legend>
				<input type="checkbox" class="checkbox" <?php echo ($instance['markup']['custom_html']) ? 'checked="checked"' : ''; ?> id="<?php echo $this->get_field_id( 'custom_html' ); ?>" name="<?php echo $this->get_field_name( 'custom_html' ); ?>" /> <label for="<?php echo $this->get_field_id( 'custom_html' ); ?>"><?php _e('Use custom HTML Markup', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />
				<?php if ($instance['markup']['custom_html']) : ?>
				<br />
				<p style="font-size:11px"><label for="<?php echo $this->get_field_id( 'title-start' ); ?>"><?php _e('Before / after title:', 'cherry'); ?></label> <br />
				...
				<p style="font-size:11px"><label for="<?php echo $this->get_field_id( 'wpp_start' ); ?>"><?php _e('Before / after Popular Posts:', 'cherry'); ?></label> <br />
				...
				<p style="font-size:11px"><label for="<?php echo $this->get_field_id( 'post-start' ); ?>"><?php _e('Before / after each post:', 'cherry'); ?></label> <br />
				...
				<hr />
				<?php endif; ?>
				<input type="checkbox" class="checkbox" <?php echo ($instance['markup']['pattern']['active']) ? 'checked="checked"' : ''; ?> id="<?php echo $this->get_field_id( 'pattern_active' ); ?>" name="<?php echo $this->get_field_name( 'pattern_active' ); ?>" /> <label for="<?php echo $this->get_field_id( 'pattern_active' ); ?>"><?php _e('Use content formatting tags', 'cherry'); ?></label> <small>[<a href="<?php echo bloginfo('wpurl'); ?>/wp-admin/options-general.php?page=wpp_admin" title="<?php _e('What is this?', 'cherry'); ?>">?</a>]</small><br />
				<?php if ($instance['markup']['pattern']['active']) : ?>
				<br />
				<p style="font-size:11px"><label for="<?php echo $this->get_field_id( 'pattern_form' ); ?>"><?php _e('Content format:', 'cherry'); ?></label>
			...
			if (current_user_can('manage_options') && ($token === $key) && !empty($clear)) {
				...
				if ($clear == 'cache') {
					if ( $wpdb->get_var("SHOW TABLES LIKE '$cache'") == $cache ) {
						...
						_e('Success! The cache table has been cleared!', 'cherry');
					} else {
						_e('Error: cache table does not exist.', 'cherry');
					}
				} else if ($clear == 'all') {
					if ( $wpdb->get_var("SHOW TABLES LIKE '$table'") == $table && $wpdb->get_var("SHOW TABLES LIKE '$cache'") == $cache ) {
						$wpdb->query("TRUNCATE TABLE $table;");
						$wpdb->query("TRUNCATE TABLE $cache;");
						_e('Success! All data have been cleared!', 'cherry');
					} else {
						_e('Error: one or both data tables are missing.', 'cherry');
					}
				} else {
					_e('Invalid action.', 'cherry');
				}
			} else {
				_e('Sorry, you do not have enough permissions to do this. Please contact the site administrator for support.', 'cherry');
			}
...
<!-- End Wordpress Popular Posts v<?php echo $this->version; ?> -->
		...
		function get_popular_posts($instance, $return = false) {
			...
			// post filters			
			// * post types - based on code seen at https://github.com/williamsba/cherry-with-Custom-Post-Type-Support
			...
			if ( !is_array($mostpopular) || empty($mostpopular) ) { // no posts to show
				$content .= "<p>".__('Sorry. No data so far.', 'cherry')."</p>"."\n";
			} else { // list posts
				...
				$posts_data  = array();
				$post_count  = 0;
				$adv_sidebar = 4; // adv sidebar - output after 4 posts
				...
				foreach($mostpopular as $p) {
					...
					if ( $instance['stats_tag']['comment_count'] ) {
						$stats .= "<span class=\"wpp-comments\">{$comments} " . __('comment(s)', 'cherry') . "</span>";
					}
					// views
					if ( $instance['stats_tag']['views'] ) {
						$views_text = ' ' . __('view(s)', 'cherry');
						
						if ($instance['order_by'] == 'avg') {
							if ($instance['range'] != 'daily') $views_text = ' ' . __('view(s) per day', 'cherry');
						}
					...
					if ($instance['thumbnail']['active'] && $this->thumb) {
						...
						if ($this->user_ops['tools']['thumbnail']['source'] == "featured") { // get Featured Image
							if (function_exists('has_post_thumbnail') && has_post_thumbnail( $p->id )) {
								...
								$image = aq_resize( $path, $tbWidth, $tbHeight, true );
								
								if ($path) {
									$thumb .= "<img src=\"". $image ."\" alt=\"{$title}\" class=\"wpp-thumbnail wpp_fi\" />";
								} else {
									$thumb .= "<img src=\"". $this->default_thumbnail ."\" alt=\"{$title}\" width=\"{$tbWidth}\" height=\"{$tbHeight}\" class=\"wpp-thumbnail wpp_fi_def\" />";
								}
							} else {
								$thumb .= "<img src=\"". $this->default_thumbnail ."\" alt=\"{$title}\" width=\"{$tbWidth}\" height=\"{$tbHeight}\" class=\"wpp-thumbnail wpp_fi_def\" />";
							}
							...
							if ($path) {
								$thumb .= "<img src=\"". $image ."\" alt=\"{$title}\" class=\"wpp-thumbnail wpp_fp\" />";
							} else {
								$thumb .= "<img src=\"". $this->default_thumbnail ."\" alt=\"{$title}\" width=\"{$tbWidth}\" height=\"{$tbHeight}\" class=\"wpp-thumbnail wpp_fp_def\" />";
							}
							...
							if ($path != "") {
								$thumb .= "<img src=\"{$image}\" width=\"{$tbWidth}\" height=\"{$tbHeight}\" alt=\"{$title}\" class=\"wpp-thumbnail wpp_cf\" />";
							} else {
								$thumb .= "<img src=\"". $this->default_thumbnail ."\" alt=\"{$title}\" width=\"{$tbWidth}\" height=\"{$tbHeight}\" class=\"wpp-thumbnail wpp_cf_def\" />";
							}
						}
					...
					$data = array(
						'title' => '<h4 class="wpp-title"><a href="'.$permalink.'" title="'.$title.'">'.$title_sub.'</a></h4>',
						'summary' => $excerpt,
						'stats' => $stats,
						'img' => $thumb,
						'id' => $p->id
		...
		*/
		...
		function wpp_textdomain() {
			load_plugin_textdomain('cherry', false, dirname(plugin_basename( __FILE__ )));
		}
		
		// version update warning
		function wpp_update_warning() {
			$msg = '<div id="wpp-message" class="error fade"><p>'.__('Your Wordpress version is too old. Wordpress Popular Posts Plugin requires at least version 2.8 to function correctly. Please update your blog via Tools &gt; Upgrade.', 'cherry').'</p></div>';
			echo trim($msg);
		}
